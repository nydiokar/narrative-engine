...
story:
- id: 756f9bd2-5fbb-411b-82e8-1245a9c82316
...
theme:
- id: 91102305-0429-402e-a3f0-eedf1dbd68e9
  primary_themes:
  - name: freedom
...
Produce your output as a single JSON object matching the output schema in your role definition. The current step is "set_world_axes". Include all required fields: success (bool), message (str), errors (array), artifacts (array), and any step-specific data as contract_data.