...
### divide_episodes — LLM-driven
Read episode contracts and character arcs. Return chapter objects as `contracts_data`. If `contracts_data` is empty, the system creates 3 fallback chapters per episode.
